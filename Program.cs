...
namespace DependencyInversionPrinciple
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Number of female managers among Employees (3) is : {stats3.CountFemaleManagers()}");
            Console.WriteLine();
            ...
            Console.WriteLine($"Number of female and managers among Employees/Students (5) is : {femaleAndManagersCount}");
            femaleOrManagersCount = stats5.CountData(s => s.Gender == Gender.Female || s.Position == Position.Manager);
            Console.WriteLine($"Number of female or managers among Employees/Students (5_1) is : {femaleOrManagersCount}");
